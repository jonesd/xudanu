...
export function LeftRail({ activeItem, onNavigate, onOpenLibrary, onOpenSearch }: LeftRailProps) {
  ...
  return (
    <div className="left-rail">
      ...
      <div className="rail-separator" />
      <a href="https://jonesd.github.io/xudanu/" target="_blank" rel="noopener noreferrer" title="Documentation"
        style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%", height: "40px", color: "var(--text-muted)", textDecoration: "none", cursor: "pointer", borderRadius: "6px", marginTop: "auto" }}>
