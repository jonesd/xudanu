...
message 415 TableStepper grants(IDRegionOrNull clubIDs)
message 416 TableStepper grants(IDRegionOrNull clubIDs, IDRegionOrNull globalIDs)
...
message 423 Edition restore(EditionOrNull works, Edition medium)
}
...
message 9 Void store(IntValue index, PromiseOrNull value) login
message 258 Void storeAll() login
message 259 Void storeAll(PromiseOrNull value) login
message 260 Void storeAll(PromiseOrNull value, IntValue count) login
message 261 Void storeAll(PromiseOrNull value, IntValue count, IntValue start) login
...
message 279 Mapping crossOfMappings(PtrArrayOrNull subMappings)
message 426 CrossOrderSpec crossOfOrderSpecs()
message 427 CrossOrderSpec crossOfOrderSpecs(PtrArrayOrNull subOrderings)
message 428 CrossOrderSpec crossOfOrderSpecs(PtrArrayOrNull subOrderings, IntArrayOrNull subSpaceOrdering)
...
message 286 SequenceMapping mapping(IntValue shift, SequenceOrNull translation)
...
message 73 Edition transcluders(FilterOrNull directFilter)
message 74 Edition transcluders(FilterOrNull directFilter, FilterOrNull indirectFilter)
message 75 Edition transcluders(FilterOrNull directFilter, FilterOrNull indirectFilter, IntValue transclusionFlags)
message 316 Edition transcluders(FilterOrNull directFilter, FilterOrNull indirectFilter, IntValue transclusionFlags, EditionOrNull otherTranscluders)
message 76 Edition works()
message 77 Edition works(FilterOrNull filter)
message 78 Edition works(FilterOrNull filter, IntValue transclusionFlags)
message 317 Edition works(FilterOrNull filter, IntValue transclusionFlags, EditionOrNull otherTranscluders)
}
...
function 84 Edition fromArray(Array values, RegionOrNull keys)
function 318 Edition fromArray(Array values, RegionOrNull keys, OrderSpecOrNull ordering)
...
message 320 Region canMakeRangeIdentical(Edition newIdentities, RegionOrNull positions)
...
message 325 Edition makeRangeIdentical(Edition newIdentities, RegionOrNull positions)
...
message 327 IDRegion rangeOwners(RegionOrNull positions)
message 103 Edition rangeTranscluders()
message 104 Edition rangeTranscluders(RegionOrNull positions)
message 105 Edition rangeTranscluders(RegionOrNull positions, FilterOrNull directFilter)
message 106 Edition rangeTranscluders(RegionOrNull positions, FilterOrNull directFilter, FilterOrNull indirectFilter)
message 107 Edition rangeTranscluders(RegionOrNull positions, FilterOrNull directFilter, FilterOrNull indirectFilter, IntValue transclusionFlags)
message 328 Edition rangeTranscluders(RegionOrNull positions, FilterOrNull directFilter, FilterOrNull indirectFilter, IntValue transclusionFlags, EditionOrNull otherTranscluders)
message 329 Edition rangeWorks()
message 330 Edition rangeWorks(RegionOrNull positions)
message 331 Edition rangeWorks(RegionOrNull positions, FilterOrNull filter)
message 332 Edition rangeWorks(RegionOrNull positions, FilterOrNull filter, IntValue transclusionFlags)
message 333 Edition rangeWorks(RegionOrNull positions, FilterOrNull filter, IntValue transclusionFlags, EditionOrNull otherTrail)
...
message 111 Stepper retrieve(RegionOrNull positions)
message 112 Stepper retrieve(RegionOrNull positions, OrderSpecOrNull order)
message 113 Stepper retrieve(RegionOrNull positions, OrderSpecOrNull order, IntValue retrieveFlags)
message 335 Edition setRangeOwners(ID newOwner)
message 336 Edition setRangeOwners(ID newOwner, RegionOrNull region)
...
message 119 TableStepper stepper(RegionOrNull region)
message 337 TableStepper stepper(RegionOrNull region, OrderSpecOrNull ordering)
...
message 350 Void setEditClub(IDOrNull club)
message 351 Void setHistoryClub(IDOrNull club)
message 352 Void setReadClub(IDOrNull club)
...
message 359 Void setSignatureClub(IDOrNull club)
message 360 ID signatureClub()
message 361 Edition sponsoredWorks()
message 362 Edition sponsoredWorks(FilterOrNull filter)
}
...
function 364 ID assignID(RangeElement range, IDOrNull iD)
...
function 369 ClubDescription make(SetOrNull members, LockSmithOrNull lockSmith)
...
message 376 HyperRef withOriginalContext(WorkOrNull work)
message 377 HyperRef withPathContext(PathOrNull path)
message 378 HyperRef withWorkContext(WorkOrNull work)
message 168 Work workContext()
}
class 60 MultiRef HyperRef {
function 169 MultiRef make(PtrArrayOrNull refs)
function 170 MultiRef make(PtrArrayOrNull refs, WorkOrNull workContext)
function 171 MultiRef make(PtrArrayOrNull refs, WorkOrNull workContext, WorkOrNull originalContext)
function 172 MultiRef make(PtrArrayOrNull refs, WorkOrNull workContext, WorkOrNull originalContext, PathOrNull pathContext)
...
function 174 SingleRef make(EditionOrNull material)
function 175 SingleRef make(EditionOrNull material, WorkOrNull workContext)
function 176 SingleRef make(EditionOrNull material, WorkOrNull workContext, WorkOrNull originalContext)
function 177 SingleRef make(EditionOrNull material, WorkOrNull workContext, WorkOrNull originalContext, PathOrNull pathContext)
...
function 186 Text make(ArrayOrNull data)
...
message 197 Region chooseMany(IntValue n, OrderSpecOrNull order)
message 198 Position chooseOne()
message 199 Position chooseOne(OrderSpecOrNull order)
...
message 212 Stepper stepper(OrderSpecOrNull order)
...
message 398 Stepper intervals(OrderSpecOrNull order)
...
message 399 Stepper intervals(OrderSpecOrNull order)
...
message 400 Stepper intervals(OrderSpecOrNull order)
