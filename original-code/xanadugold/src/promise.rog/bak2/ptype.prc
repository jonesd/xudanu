...
class 4 Array<T> Promise {
message 468 Array<T> copy() login
message 469 Array<T> copy(IntValue count) login
message 255 Array<T> copy(IntValue count, IntValue start) login
message 424 Array<T> copy(IntValue count, IntValue start, IntValue before) login
message 425 Array<T> copy(IntValue count, IntValue start, IntValue before, IntValue after) login
...
message 8 T get(IntValue index) login
message 9 Void store(IntValue index, T value) login
message 258 Void storeAll() login
message 259 Void storeAll(T value) login
message 260 Void storeAll(T value, IntValue count) login
message 261 Void storeAll(T value, IntValue count, IntValue start) login
message 262 Void storeMany(IntValue to, Array<T> other) login
message 263 Void storeMany(IntValue to, Array<T> other, IntValue count) login
message 264 Void storeMany(IntValue to, Array<T> source, IntValue count, IntValue from) login
}
class 5 FloatArray Array<FloatValue> {
...
class 6 HumberArray Array<IntValue> {
function 268 HumberArray import(Special args) login
function 269 HumberArray zeros(IntValue count) login
}
class 7 IntArray Array<IntValue> {
function 10 IntArray import(Special args) login
function 11 Array zeros(IntValue bitCount, IntValue count) login
message 12 IntValue bitCount()
}
class 8 PtrArray<T> Array<T> {
function 270 PtrArray<T> import(Special args)
function 271 PtrArray<T> nulls(IntValue count)
}
class 9 Bundle<CS> Promise {
message 13 Region<CS> region()
}
class 10 ArrayBundle<CS> Bundle<CS> {
message 14 Array<Value> array()
message 15 OrderSpec<CS> ordering()
}
...
class 13 CoordinateSpace<CS> Promise {
message 272 OrderSpec<CS> ascending()
message 273 Mapping<CS,CS2> completeMapping(Region<CS2> range)
message 274 OrderSpec<CS> descending()
message 17 Region<CS> emptyRegion()
message 18 Region<CS> fullRegion()
message 19 Mapping<CS> identityMapping()
}
class 14 CrossSpace<CS..> CoordinateSpace<CrossSpace<CS..>> {
function 20 CrossSpace make(PtrArray<CS..> subSpaces)
message 275 PtrArray<CS..> axes()
message 276 CS axis(IntValue dimension)
message 277 IntValue axisCount()
message 278 Mapping<CrossSpace<CS..>,CrossSpace<CS..>> crossOfMappings()
message 279 Mapping<CrossSpace<CS..>,CrossSpace<CS2..>> crossOfMappings(PtrArray<Mapping<CS..,CS2..>> subMappings)
message 426 CrossOrderSpec<CS..> crossOfOrderSpecs()
message 427 CrossOrderSpec<CS..> crossOfOrderSpecs(PtrArray<OrderSpec<CS..>> subOrderings)
message 428 CrossOrderSpec<CS..> crossOfOrderSpecs(PtrArray<OrderSpec<CS..>> subOrderings, IntArray subSpaceOrdering)
message 21 Tuple<CS..> crossOfPositions(PtrArray<Position<CS..>> coordinates)
message 22 CrossRegion<CS..> crossOfRegions(PtrArray<Region<CS..>> subRegions)
message 23 CrossRegion<CS..> extrusion(IntValue dimension, Region<CS..> subRegion)
}
class 15 FilterSpace<BS> CoordinateSpace<FilterSpace<BS>> {
function 280 FilterSpace<BS> make(BS base)
message 24 Filter<BS> allFilter(Region<BS> region)
message 25 Filter<BS> anyFilter(Region<BS> region)
message 281 BS baseSpace()
message 429 FilterPosition position(Region<BS> region)
}
class 16 IDSpace CoordinateSpace<IDSpace> {
...
class 17 IntegerSpace CoordinateSpace<IntegerSpace> implicit {
...
class 18 RealSpace CoordinateSpace<RealSpace> {
...
class 19 SequenceSpace CoordinateSpace<SequenceSpace> implicit {
...
class 29 Mapping<CS1,CS2> Promise {
message 46 Mapping<CS1,CS2> combine(Mapping<CS1,CS2> other)
message 47 Region<CS1> domain()
message 294 CS1 domainSpace()
message 48 Mapping<CS2,CS1> inverse()
message 49 BooleanValue isComplete()
message 50 BooleanValue isIdentity()
message 51 Position<CS2> of(Position<CS1> before)
message 52 Region<CS2> ofAll(Region<CS1> before)
message 295 Region<CS2> range()
message 296 CS2 rangeSpace()
message 53 Mapping<CS1,CS2> restrict(Region<CS1> region)
message 54 Stepper<Mapping<CS1,CS2>> simplerMappings()
message 55 Mapping<Mapping<CS1,CS2>> unrestricted()
}
class 30 CrossMapping<CS1..,CS2..> Mapping<CrossSpace<CS1..>,CrossSpace<CS2..>> {
message 297 Mapping<CS1..,CS2..> subMapping(IntValue index)
message 298 PtrArray<Mapping<CS1..,CS2..>> subMappings()
}
class 31 IntegerMapping Mapping<IntegerSpace,IntegerSpace> {
message 56 IntValue translation()
}
class 32 SequenceMapping Mapping<SequenceSpace,SequenceSpace> {
message 57 IntValue shift()
message 58 Sequence translation()
}
class 33 OrderSpec<CS> Promise {
message 299 CS coordinateSpace()
message 59 BooleanValue follows(Position<CS> x, Position<CS> y)
message 300 OrderSpec<CS> reversed()
}
class 34 CrossOrderSpec<CS..> OrderSpec<CrossSpace<CS..>> {
message 301 IntArray lexOrder()
message 302 OrderSpec<CS..> subOrder(IntValue i)
message 303 PtrArray<OrderSpec<CS..>> subOrders()
}
class 35 Position<CS> Promise {
message 60 Region<CS> asRegion()
message 304 CS coordinateSpace()
}
class 36 FilterPosition<BS> Position<FilterSpace<BS>> {
message 437 Region<BS> baseRegion()
}
class 37 ID Position<IDSpace> {
function 305 ID import(IntArray data) login
message 306 IntArray export()
}
class 38 Sequence Position<SequenceSpace> {
message 61 IntValue firstIndex()
message 307 IntValue integerAt(IntValue index)
message 62 Array<IntValue> integers()
message 63 BooleanValue isZero()
message 308 IntValue lastIndex()
message 309 Sequence with(IntValue index, IntValue number)
}
class 39 Tuple<CS..> Position<CrossSpace<CS..>> {
message 64 Position<CS..> coordinate(IntValue index)
message 65 PtrArray<Position<CS..>> coordinates()
}
class 40 Integer Position<IntegerSpace> {
message 66 IntValue value()
}
class 41 Real Position<RealSpace> {
...
message 73 Edition transcluders(Filter<CrossSpace[IDSpace,IDSpace]> directFilter)
message 74 Edition transcluders(Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter)
message 75 Edition transcluders(Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter, IntValue transclusionFlags)
message 316 Edition transcluders(Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter, IntValue transclusionFlags, Edition otherTranscluders)
message 76 Edition works()
message 77 Edition works(Filter<CrossSpace[IDSpace,IDSpace]> filter)
message 78 Edition works(Filter<CrossSpace[IDSpace,IDSpace]> filter, IntValue transclusionFlags)
message 317 Edition works(Filter<CrossSpace[IDSpace,IDSpace]> filter, IntValue transclusionFlags, Edition otherTranscluders)
}
...
message 105 Edition rangeTranscluders(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> directFilter)
message 106 Edition rangeTranscluders(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter)
message 107 Edition rangeTranscluders(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter, IntValue transclusionFlags)
message 328 Edition rangeTranscluders(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> directFilter, Filter<CrossSpace[IDSpace,IDSpace]> indirectFilter, IntValue transclusionFlags, Edition otherTranscluders)
message 329 Edition rangeWorks()
message 330 Edition rangeWorks(Region positions)
message 331 Edition rangeWorks(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> filter)
message 332 Edition rangeWorks(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> filter, IntValue transclusionFlags)
message 333 Edition rangeWorks(Region positions, Filter<CrossSpace[IDSpace,IDSpace]> filter, IntValue transclusionFlags, Edition otherTrail)
...
message 132 CrossRegion[IDSpace,IDSpace] endorsements()
...
message 362 Edition sponsoredWorks(Filter<CrossSpace[IDSpace,IDSpace]> filter)
}
...
class 53 Stepper<T> Promise {
message 151 BooleanValue atEnd()
message 254 Stepper<T> copy()
message 152 T get()
message 153 Void step()
message 154 Array<T> stepMany()
message 155 Array<T> stepMany(IntValue count)
message 156 T theOne()
}
class 54 TableStepper<K,V> Stepper {
message 157 K position()
message 158 Array<[K,V..]> stepManyPairs()
message 159 Array<[K,V..]> stepManyPairs(IntValue count)
}
...
message 194 Filter<CrossSpace[IDSpace,IDSpace]> filter()
message 390 Sequence name()
message 195 Wrapper wrap(Edition edition)
}
class 72 Region<CS> Promise {
message 196 Region<CS> chooseMany(IntValue n)
message 197 Region<CS> chooseMany(IntValue n, OrderSpec<CS> order)
message 198 Position chooseOne()
message 199 Position chooseOne(OrderSpec order)
message 200 Region<CS> complement()
message 201 CoordinateSpace coordinateSpace()
message 202 IntValue count()
message 203 BooleanValue hasMember(Position atPos)
message 204 Region<CS> intersect(Region<CS> other)
message 205 BooleanValue intersects(Region<CS> other)
message 206 BooleanValue isEmpty()
message 207 BooleanValue isFinite()
message 208 BooleanValue isFull()
message 209 BooleanValue isSubsetOf(Region<CS> other)
message 210 Region<CS> minus(Region<CS> other)
message 211 Stepper stepper()
message 212 Stepper stepper(OrderSpec order)
message 213 Position theOne()
message 214 Region<CS> unionWith(Region<CS> other)
message 215 Region<CS> with(Position pos)
message 216 Region<CS> without(Position pos)
}
class 73 CrossRegion<CS..> Region<CrossSpace<CS..>> {
message 217 Stepper<CrossRegion<CS..>> boxes()
message 218 BooleanValue isBox()
message 219 Region<CS..> projection(IntValue index)
message 220 PtrArray<Region<CS..>> projections()
}
