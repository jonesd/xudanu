...
#  EXTRACLEANING = file1 file2		- extra things for make clean
#  CXXOPTS = -CRUTCH
#
...
#  for C++2.1
SYSINCLUDES = -I/usr/local/lang/SC1.0/include/CC -I/usr/local/lang/SC1.0/include -I/usr/include
#  for C++2.0
#CXXPLATFORMLIBS = -L/usr/local/share/bin/nat2.0/sun4
#SYSINCLUDES = -I/usr/local/share/bin/nat2.0/sun4/incl -I/usr/include

PROFILING_SWITCH = -pg 
COMPILER_SYS_DEFINES =
NM_FORMAT_ARG =


INCLUDES = -I. -I.. -I$(XPPDIR)/xpp -I$(XPPDIR)/xlatexpp -I$(XPPDIR)/comm -I../sxx $(EXTRAINCLUDES) $(SYSINCLUDES)
DEFINES = $(EXTRADEFS)
CXXDEFINES = -DUSE_INLINE $(DEFINES) 
#CXXDEFINES = $(DEFINES) 
...
#
CC        = cc
CFLAGS    = -g $(PROFILING_SWITCH) $(INCLUDES)
