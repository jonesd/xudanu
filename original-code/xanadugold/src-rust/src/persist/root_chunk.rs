...
pub struct ServerRootChunk {
    ...
    /// Shadows are ephemeral (rebuilt at restore); only this set
...
pub fn checkpoint_write_root(
    ...
    let root = ServerRootChunk {
        ...
        backfollow_snapshot_hash: manifest.backfollow_snapshot_hash,
        recorder_journal_hash: manifest.recorder_journal_hash,
        admin_hash,
...
pub fn read_root_as_manifest(
    ...
    let manifest = crate::persist::manifest::Manifest {
        ...
        backfollow_snapshot_hash: root.backfollow_snapshot_hash,
        recorder_journal_hash: root.recorder_journal_hash,
