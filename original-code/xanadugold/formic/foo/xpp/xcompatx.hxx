 ...
 * - Added include of <libc.h> or <string.h> to support bcopy redefinitions.
 *    - michael Aug 29/Sep 5 1991  (merged Mar 24 1992)
 * - Added (temporarily!!!!) CANT_REDEFINE_PURE_VIRTUAL_CALLED
 *    - michael Mar 24 1992
 */
...
#define	CANT_REDEFINE_PURE_VIRTUAL_CALLED
#endif	/* sgi */
...
/*   fake conversion functions so that we can treat UInt1 and char as different
     types.
*/
REQUIRE(2,"hard cast")
inline UInt1 uint1(char ch) { return((UInt1) ch); }
inline char character(UInt1 ui) { return((char) ui); }
PERMIT(0,"hard cast")
...
/* Standard libraries, which contain support for bcopy, which changes... */
